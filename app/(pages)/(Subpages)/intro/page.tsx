	...
	return (
		<>
			<div className={styles.intro__container}>
				...
				<p>이번 협약을 통해 핑거 AML Hub는 한국의 AML 전문가들을 위한 전문 서비스 플랫폼으로 자리매김하고자 합니다.</p><br className="show-mo"/>
				<p>현재 우리나라 금융업계가 직면한 주요 과제 중 하나인 자금세탁 위험에 효과적으로 대응하기 위한 전문 인력 양성을 위해,</p>
				<p>핑거 AML Hub는 ACAMS와의 업무협약을 통해 비용 효율적인 국제공인 자격증 신청 경로를 제공합니다.</p><br className="show-mo"/>
				<p>앞으로 핑거는 첨단 기술을 활용한 혁신적인 금융범죄 예방 솔루션 개발과 AML 커뮤니티 구축을 통해 이 분야의 선도적 역할을 수행해 나갈 것입니다.</p><br className="show-mo"/>
